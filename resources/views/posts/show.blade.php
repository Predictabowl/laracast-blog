                    ...
                    @auth
                        <x-panel>
                            <form method="POST" action="/post/{{$post->slug}}/comments">
                                ...
                                <div class="mt-4">
                                    <textarea name="body" class="w-full text-sm focus:outline-none focus:ring" rows="5" placeholder="Scrivi un commento."></textarea>
                                </div>
                                <div class="flex justify-end mt-4 pt-4 border-t border-gray-200">
                                    <button type="submit"
                                        class="bg-blue-500 text-white font-semibold text-sm py-2 px-10 uppercase rounded-2xl hover:bg-blue-600">
                                        Posta
                                    </button>
                                </div>
                            </form>
